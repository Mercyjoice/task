...
public class IntegrationTests {
	...
	public void testCreate() {
		Employee employee = new Employee("Medha", "Gupta");

		Employee employeeResult = employeeController.employeeService.save(employee);
		Assertions.assertThat(employeeResult);
	}
	...
	public void errorHandlingValidationExceptionThrown() {
		...
		Assertions.assertThatExceptionOfType(ValidationException.class).isThrownBy(() -> employeeController.somethingIsWrong());
	}
}
